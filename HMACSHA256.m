...
+ (NSString *)sortUrlString:(NSString *)unsortedUrlString
{
    ...
    NSString *escapedUnsortedUrlString = (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL, (CFStringRef)unsortedUrlStringWithoutHTTPAddress,
                                                                                             NULL, (CFStringRef)@"!*'();:@+$,/?%#[]",
                 ...
                 withSecret:(NSString *)secretKey
{
    ...
    NSString *signature	= (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL, (CFStringRef) signatureUncoded,
                                                                                              NULL, (CFStringRef) @"+/=",
                                                                                              kCFStringEncodingUTF8));
...
+ (NSString *)base64forData:(NSData *)data
{
    ...
    NSString *encodedString = [[NSString alloc] initWithBytesNoCopy:characters length:length
